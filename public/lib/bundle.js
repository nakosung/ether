...
app.factory('world', function(rpc, autocol, $rootScope) {
  ...
  World = (function() {
    ...
    World.prototype.tick = function(deltaTick) {
      var VELOCITY, actions, e, get_dir, intTick, k, _ref, _ref1, _ref2, _ref3,
        _this = this;
      ...
      if (this.angular_spin-- < 0) {
        ...
        this.scope.stats = {
          x: (_ref2 = this.avatar) != null ? _ref2.x : void 0,
          y: (_ref3 = this.avatar) != null ? _ref3.y : void 0
        };
        this.scope.$apply();
      }
      return false;
...
*/
},{"../shared/entity":8,"../shared/vector":5,"../shared/map":9}],4:[function(require,module,exports){
var ether,
  __slice = [].slice;
...
*/
},{"./ether":4}],10:[function(require,module,exports){
...
Entity = (function() {
  ...
  Entity.prototype.tick = function(deltaTick) {
    var c, delta, dirty, e, is_solid, new_delta, _ref1,
      _this = this;

    dirty = false;
    this.vel = this.vel.mad(deltaTick, gravity);
    if (this.vel.y > TERMINAL_VELOCITY) {
      this.vel.y = TERMINAL_VELOCITY;
    }
    c = function(x, y) {
    ...
    while (delta.size()) {
      try {
        _ref1 = physics.walk(this.pos, delta, is_solid), this.pos = _ref1[0], new_delta = _ref1[1];
        if (new_delta.size()) {
          dirty = true;
          if (new_delta.x) {
            this.vel.x = 0;
...
*/
},{"./vector":5,"./physics":15,"./map":9}],13:[function(require,module,exports){
...
},{"assert":12,"./buffer_ieee754":16,"base64-js":17}],15:[function(require,module,exports){
var Vector, col, col_eps, dim_range, one, sweep, walk, _i, _ref, _results,
  _this = this;
...
sweep = function(p1, p2, is_solid) {
  var V, a0, a1, b0, b1, d, m;

  d = p2.sub(p1).size();
  if (d > 1) {
    m = p1.add(p2).mul(0.5);
    return sweep(p1, m, is_solid) || sweep(m, p2, is_solid);
  }
  a0 = p1.floor();
