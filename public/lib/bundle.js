...
Entity = (function() {
  ...
  Entity.prototype.tick = function(deltaTick) {
    var counter, dirty, fracY, intY, newPos;
    ...
    counter = 0;
    while (!this.map.is_empty(this.pos && counter < 10)) {
      counter += 1;
      intY = Math.floor(this.pos.y);
      fracY = this.pos.y - intY;
      this.pos.y = intY - 1;
      this.flying = false;
      dirty = true;
      this.vel.y = 0;
    ...
    console.log(this.pos, this.vel, this.flying);
    newPos = this.pos.mad(deltaTick, this.vel);
    if (this.map.is_empty(newPos)) {
      this.pos = newPos;
    } else {
      this.vel.zero();
    }
    if (this.vel.square() > 0) {
      dirty = true;
    }
    return dirty;
  };
...
var CHUNK_SIZE_MASK, Entity, Map, TILE_SIZE, Vector, app, _, _ref,
...
_ref = require('../shared/map'), Map = _ref.Map, CHUNK_SIZE_MASK = _ref.CHUNK_SIZE_MASK;
...
app.factory('world', function(rpc, autocol, $rootScope) {
  ...
  World = (function() {
    ...
    World.prototype.tick = function(deltaTick) {
      var VELOCITY, actions, e, intTick, k, _ref1, _ref2, _ref3, _ref4;
...
*/
},{"./ether":4,"../shared/map":9,"../shared/vector":5,"../shared/entity":8,"underscore":13}],11:[function(require,module,exports){
...
},{"assert":10,"./buffer_ieee754":14,"base64-js":15}],15:[function(require,module,exports){
(function (exports) {
	'use strict';
