...
*/
},{"./ether":4}],8:[function(require,module,exports){
var CHUNK_SIZE_MASK, Entity, Map, Vector, gravity, physics, _ref;
...
Entity = (function() {
  ...
  Entity.prototype.tick = function(deltaTick) {
    var altered, c, dirty, is_solid, newPos,
      _this = this;

    dirty = false;
    if (this.is_flying() || this.vel.y) {
      this.vel = this.vel.mad(deltaTick, gravity);
    }
    c = function(x, y) {
      return _this.map.get_block_type(x, y) !== 0;
    };
    is_solid = function(p) {
    ...
    while (this.vel.size() > 0) {
      newPos = this.pos.mad(deltaTick, this.vel);
      altered = physics.sweep(this.pos, newPos, is_solid);
      if (altered) {
    ...
    return dirty || this.flying || this.vel.size();
  };
...
*/
},{"./vector":5,"./physics":9,"./map":10}],11:[function(require,module,exports){
(function(){// UTILITY
...
},{"util":12,"buffer":13}],12:[function(require,module,exports){
...
var CHUNK_SIZE_BIT, CHUNK_SIZE_MASK, Entity, Map, TILE_SIZE, Vector, app, _, _ref,
...
app.factory('world', function(rpc, autocol, $rootScope) {
  var ClientEntity, ClientMap, World;
  ...
  ClientMap = (function(_super) {
    ...
    ClientMap.prototype.give_chunk = function(chunk_key, buf) {
      return this.receivedChunks[chunk_key] = buf;
    };
    ...
    ClientMap.prototype.generate = function(chunk, cb) {
      ...
      buf = this.receivedChunks[chunk.key];
      ...
      if (buf) {
        ...
        return rpc.world.sub_chunk(chunk.key, function(err, buf) {
          if (err) {
            return cb(err);
          }
          chunk.buffer = buf;
  ...
  World = (function() {
    function World(scope, pg, opts) {
      ...
      this.map = new ClientMap(this.pg, {
      ...
      enter = function() {
        ...
        if (((_ref1 = rpc.world) != null ? _ref1.enter : void 0) != null) {
    ...
    World.prototype.createEntity = function(opt) {
      var age, e, id, pos, sprite_id, vel;

      id = opt.id, pos = opt.pos, vel = opt.vel, age = opt.age;
      this.entities[opt.id] = e = new ClientEntity(this.map, id, pos, vel, age);
    ...
    World.prototype.keypressed = function(key) {
      return $.gQ.keyTracker[this.keymap[key]];
    };
    ...
    World.prototype.handlePacket = function(json) {
      ...
      if (json.remove != null) {
        this.deleteEntity(json.remove);
      }
      if (json.chunk != null) {
        this.map.give_chunk(json.chunk.key, json.chunk.buf);
      }
    ...
    World.prototype.tick = function(deltaTick) {
      var VELOCITY, actions, dir, e, intTick, k, _ref1, _ref2, _ref3, _ref4;
      ...
      if ((_ref1 = this.currentTick) == null) {
        this.currentTick = 0;
      }
      ...
      if (this.angular_spin-- < 0) {
        ...
        this.scope.stats = {
          x: (_ref3 = this.avatar) != null ? _ref3.x : void 0,
          y: (_ref4 = this.avatar) != null ? _ref4.y : void 0
        };
        this.scope.$apply();
      }
      return false;
...
*/
},{"./ether":4,"../shared/vector":5,"../shared/entity":8,"../shared/map":10,"underscore":14}],15:[function(require,module,exports){
...
walk = function(p1, p2, is_solid) {
  var V, a0, a1, b0, b1, d, m;

  d = p2.sub(p1).size();
  if (d > 1) {
    m = p1.add(p2).mul(0.5);
    return walk(p1, m, is_solid) || walk(m, p2, is_solid);
  }
  a0 = p1.floor();
  a1 = p1.add(col_eps).floor();
  b0 = p2.floor();
  b1 = p2.add(col_eps).floor();
  if (is_solid(a0) || is_solid(a1)) {
    return p1;
  }
  if (!(is_solid(b0) || is_solid(b1))) {
    return void 0;
  }
  if (p1.x !== p2.x) {
...
*/
},{"./vector":5}],16:[function(require,module,exports){
(function (exports) {
	'use strict';
...
Map = (function() {
  ...
  Map.prototype.get_chunk = function(X, Y, cb) {
    ...
    if (chunk) {
      ...
      chunk = this.chunks[key] = new Chunk(key, X, Y);
      chunk.pending = [cb];
