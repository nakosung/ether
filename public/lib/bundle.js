...
Chunk = (function(_super) {
  ...
  Chunk.prototype.sub = function() {
    return this.numSubs += 1;
  };

  Chunk.prototype.unsub = function() {
    this.numSubs -= 1;
    if (this.numSubs === 0) {
