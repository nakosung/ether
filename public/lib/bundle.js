...
app.factory('world', function(rpc, autocol, $rootScope, $location) {
  ...
  World = (function() {
    function World(scope, pg, opts) {
      ...
      this.players = this.pg.addGroup("players", {
        width: this.pg.width(),
        height: this.pg.height()
      });
      enter = function() {
        var _ref;
    ...
    World.prototype.createEntity = function(id, opt) {
      var GROUP_HEIGHT, GROUP_WIDTH, age, e, pos, sprite_id, vel;
      ...
      GROUP_WIDTH = 200;
      GROUP_HEIGHT = 100;
      e.group = this.players.addGroup(sprite_id, {
        width: GROUP_WIDTH,
        height: GROUP_WIDTH
      });
      e.group.addSprite("real" + sprite_id, {
        width: TILE_SIZE,
        height: TILE_SIZE,
...
ClientEntity = (function(_super) {
  ...
  ClientEntity.prototype.tick = function(deltaTick) {
    ...
    return (_ref1 = this.group) != null ? _ref1.xy((this.pos.x - this.map.x) * TILE_SIZE, (this.pos.y - this.map.y) * TILE_SIZE) : void 0;
  };
...
ClientMap = (function(_super) {
  ...
  function ClientMap(pg, opts) {
    ...
    this.background = this.pg.addGroup("background", {
      width: this.pg.width(),
      height: this.pg.height()
    });
    this.view = {
    ...
    for (x = _i = 0; _i <= 31; x = ++_i) {
      this.tiles.push((function() {
        ...
        sprite_id = "map" + x + "_" + y;
        _this.background.addSprite(sprite_id, {
          posx: TILE_SIZE * x,
          posy: TILE_SIZE * y,
          width: TILE_SIZE,
          height: TILE_SIZE,
...
*/
},{"./vector":5,"./map":9,"./physics":12}],13:[function(require,module,exports){
(function(){// UTILITY
