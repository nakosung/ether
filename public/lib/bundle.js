  ...
  World = (function() {
    ...
    World.prototype.updateEntity = function(opt) {
      ...
      if (e) {
        ...
        return console.log('invalid', opt);
      }
    };
...
*/
},{"../shared/entity":8,"../shared/map":9,"../shared/vector":5}],10:[function(require,module,exports){
...
},{"assert":12,"./buffer_ieee754":16,"base64-js":17}],17:[function(require,module,exports){
(function (exports) {
	'use strict';
...
Chunk = (function(_super) {
  ...
  Chunk.prototype.sub = function(fn) {
    this.on('changed', fn);
    return this.numSubs += 1;
  };

  Chunk.prototype.unsub = function(fn) {
    this.removeListener('changed', fn);
    this.numSubs -= 1;
    if (this.numSubs === 0) {
      return this.emit('nosub');
    }
  };
